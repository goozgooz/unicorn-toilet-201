...
var sportsBar = new Toilet({lat: 47.6196, lng: -122.3487}, 'Sport Restaurant & Bar (Access Code-2587)', 3, 2, 'Both', 'Gel', 'Pay');
...
var spaceNeedle = new Toilet({lat: 47.6202, lng: -122.3490}, 'Space Needle', 3, 3, 'Air Dryer', 'Gel', 'Pay');
var komoPlaza = new Toilet({lat: 47.6194, lng: -122.3483}, 'Komo 4 Plaza (Access Code-3214)', 4, 1, 'Both', 'Gel', 'Pay');

//array to hold all of our toilets
var toilets = [sportsBar, armory, porterPotty, plazaGaribaldi, dominos, codeFellows, subway, desertTan, cherryCafe, spaceNeedle, komoPlaza];
...
function questionThree(){
  prompt.innerHTML = 'Which kind of bathroom selfie person are you?';
